...
# NOTE: process_*_placeholders functions removed - now handled by
# infrastructure/handlers/placeholder_resolution.py via CodeLinksPlaceholderHandler
# and EntityDiagramPlaceholderHandler
