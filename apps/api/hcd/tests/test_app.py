"""Tests for HCD REST API application.
...
try:
    from apps.api.hcd.app import app as _app
...
@pytest.mark.skipif(not APP_IMPORTS_OK, reason="HCD API app has import errors")
class TestModuleImports:
    ...
    @pytest.mark.parametrize(
        ...
        [
            "apps.api.hcd.app",
            "apps.api.hcd.dependencies",
            "apps.api.hcd.requests",
            "apps.api.hcd.responses",
            "apps.api.hcd.routers",
            "apps.api.hcd.routers.hcd",
            "apps.api.hcd.routers.solution",
        ],
    )
    def test_module_imports(self, module_name: str) -> None:
        """All HCD API modules must import without errors."""
...
class TestAppConfiguration:
    ...
    def test_app_exists(self) -> None:
        ...
        from apps.api.hcd.app import app
...
class TestRouterRegistration:
    ...
    def test_routers_exist(self) -> None:
        """Router modules must export routers."""
        from apps.api.hcd.routers import hcd_router, solution_router

        assert hcd_router is not None
        assert solution_router is not None
...
class TestOpenAPISchema:
    ...
    def test_openapi_schema_has_info(self, client) -> None:
        ...
        assert schema["info"]["title"] == "HCD REST API"
...
class TestMainFunction:
    ...
    def test_main_function_exists(self) -> None:
        ...
        from apps.api.hcd.app import main
