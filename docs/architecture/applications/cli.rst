...
CLI commands instantiate and execute use cases directly, or trigger :doc:`worker <worker>` pipelines for asynchronous operations. CLIs read configuration from environment variables or config files. Common uses include administrative tasks, development and debugging, batch operations, and system initialization.
