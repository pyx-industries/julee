...
Workers connect to a Temporal server and poll a task queue. When a :doc:`pipeline </architecture/solutions/pipelines>` is triggered, Temporal schedules activities which the worker executes. Each activity represents a :doc:`use case </architecture/clean_architecture/use_cases>` step—fetching documents, calling AI :doc:`services </architecture/clean_architecture/services>`, storing results. Temporal records the execution history, enabling replay and recovery.
