...
class MemoryKnowledgeServiceConfigRepository(
    ...
    def __init__(self) -> None:
        ...
        self.id_field = "knowledge_service_id"
        self.storage: dict[str, KnowledgeServiceConfig] = {}
    ...
    async def get(self, knowledge_service_id: str) -> KnowledgeServiceConfig | None:
        ...
        """
        return self._get_entity(knowledge_service_id)
    ...
    async def save(self, knowledge_service: KnowledgeServiceConfig) -> None:
        ...
        """
        self._save_entity(knowledge_service)
    ...
    async def get_many(
        ...
        Returns:
            ...
            None if not found)
        """
        return self._get_many_entities(knowledge_service_ids)
    ...
    async def list_all(self) -> list[KnowledgeServiceConfig]:
        ...
        configs = list(self.storage.values())
