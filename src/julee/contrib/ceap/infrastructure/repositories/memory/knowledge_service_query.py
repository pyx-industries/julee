...
class MemoryKnowledgeServiceQueryRepository(
    ...
    def __init__(self) -> None:
        ...
        self.id_field = "query_id"
        self.storage: dict[str, KnowledgeServiceQuery] = {}
    ...
    async def get(self, query_id: str) -> KnowledgeServiceQuery | None:
        ...
        """
        return self._get_entity(query_id)
    ...
    async def get_many(
        ...
        Returns:
            ...
            found)
        """
        return self._get_many_entities(query_ids)
    ...
    async def generate_id(self) -> str:
        ...
        """
        return self._generate_id("query")
