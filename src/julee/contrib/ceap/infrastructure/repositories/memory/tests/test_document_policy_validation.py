...
class TestMemoryDocumentPolicyValidationRepositorySpecific:
    ...
    async def test_entity_specific_logging_data(
        ...
        validation_repo._add_log_extras(sample_validation, log_data)
    ...
    async def test_entity_specific_logging_data_with_error(
        ...
        log_data: dict[str, Any] = {}
        validation_repo._add_log_extras(validation_with_error, log_data)
    ...
    async def test_entity_specific_logging_data_no_transformations(
        ...
        log_data: dict[str, Any] = {}
        validation_repo._add_log_extras(validation_no_transform, log_data)
    ...
    async def test_entity_specific_logging_data_passed_none(
        ...
        log_data: dict[str, Any] = {}
        validation_repo._add_log_extras(validation_in_progress, log_data)
    ...
    async def test_initialization_sets_correct_attributes(
        ...
        assert isinstance(validation_repo.storage, dict)
        assert len(validation_repo.storage) == 0
