...
class MemoryDocumentPolicyValidationRepository(
    ...
    def __init__(self) -> None:
        ...
        self.id_field = "validation_id"
        self.storage: dict[str, DocumentPolicyValidation] = {}
    ...
    async def get(self, validation_id: str) -> DocumentPolicyValidation | None:
        ...
        """
        return self._get_entity(validation_id)
    ...
    async def generate_id(self) -> str:
        ...
        """
        return self._generate_id("validation")
    ...
    async def get_many(
        ...
        Returns:
            ...
            not found)
        """
        return self._get_many_entities(validation_ids)
