...
class MemoryPolicyRepository(PolicyRepository, MemoryRepositoryMixin[Policy]):
    ...
    def __init__(self) -> None:
        ...
        self.id_field = "policy_id"
        self.storage: dict[str, Policy] = {}
    ...
    async def get(self, policy_id: str) -> Policy | None:
        ...
        """
        return self._get_entity(policy_id)
    ...
    async def generate_id(self) -> str:
        ...
        """
        return self._generate_id("policy")
    ...
    async def get_many(self, policy_ids: list[str]) -> dict[str, Policy | None]:
        ...
        """
        return self._get_many_entities(policy_ids)

    def _add_log_extras(self, entity: Policy, log_data: dict[str, Any]) -> None:
