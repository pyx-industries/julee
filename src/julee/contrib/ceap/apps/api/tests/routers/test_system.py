...
from julee.contrib.ceap.apps.api.routers.system import router
...
def client(
    ...
    with (
        patch(
            "julee.contrib.ceap.apps.api.routers.system.check_temporal_health"
        ) as mock_temporal,
        patch(
            "julee.contrib.ceap.apps.api.routers.system.check_storage_health"
        ) as mock_storage,
    ):
