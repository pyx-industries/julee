...
An accelerator is a collection of business processes (pipelines) that form
a supply chain, enabling transparent, traceable, and trusted digital products.
...
Future: Accelerators will produce W3C Verifiable Credentials as side effects
of pipeline execution, enabling UN Transparency Protocol (UNTP) compliance
...
Semantic Relations
------------------
Accelerator PROJECTS BoundedContext - it provides a supply chain viewpoint onto
