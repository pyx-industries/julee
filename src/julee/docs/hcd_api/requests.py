...
from ..sphinx_hcd.domain.models.accelerator import Accelerator, IntegrationReference
from ..sphinx_hcd.domain.models.app import App, AppType
from ..sphinx_hcd.domain.models.epic import Epic
from ..sphinx_hcd.domain.models.integration import (
    Direction,
    ExternalDependency,
    Integration,
)
from ..sphinx_hcd.domain.models.journey import Journey, JourneyStep
from ..sphinx_hcd.domain.models.persona import Persona
from ..sphinx_hcd.domain.models.story import Story
...
class JourneyStepInput(BaseModel):
    ...
    def to_domain_model(self) -> JourneyStep:
        ...
        from ..sphinx_hcd.domain.models.journey import StepType
