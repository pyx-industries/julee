...
from julee.hcd.sphinx.directives.base import make_deprecated_directive
...
class TestDirectiveImports:
    ...
    def test_story_directives_import(self) -> None:
        ...
        from julee.hcd.sphinx.directives.story import (
            StoriesDirective,
            StoryAppDirective,
            StoryIndexDirective,
    ...
    def test_journey_directives_import(self) -> None:
        ...
        from julee.hcd.sphinx.directives.journey import (
    ...
    def test_epic_directives_import(self) -> None:
        ...
        from julee.hcd.sphinx.directives.epic import (
            DefineEpicDirective,
            EpicIndexDirective,
    ...
    def test_app_directives_import(self) -> None:
        ...
        from julee.hcd.sphinx.directives.app import (
            AppIndexDirective,
    ...
    def test_accelerator_directives_import(self) -> None:
        ...
        from julee.hcd.sphinx.directives.accelerator import (
    ...
    def test_integration_directives_import(self) -> None:
        ...
        from julee.hcd.sphinx.directives.integration import (
    ...
    def test_persona_directives_import(self) -> None:
        ...
        from julee.hcd.sphinx.directives.persona import (
...
class TestEventHandlerImports:
    ...
    def test_event_handlers_import(self) -> None:
        ...
        from julee.hcd.sphinx.event_handlers import (
            on_builder_inited,
            on_doctree_read,
            on_doctree_resolved,
            on_env_purge_doc,
